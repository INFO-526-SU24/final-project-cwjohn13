...
-I will be looking at how environmental movements effect river pollutants.

-With the increasing news surrounding big environmental movements I thought it would be interesting to see if any of these movements are effective in reducing or changing the type of pollutants that are being found in rivers.

## Introduction to the Data

-The data set being investigated is the trashwheel data set from tidyverse which presents information regarding the amount of pollutants removed from rivers by trashwheels, Trash removal devices located at the end of rivers. 

-I supplemented this with data regarding when the most prominent environmental movements took place over the last decade.

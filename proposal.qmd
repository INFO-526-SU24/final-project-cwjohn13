...
description: "This project will look into the recent increase in environmental movements and how they have changed the pollutants being removed from rivers and streams"
format:
  html:
    code-tools: true
    code-overflow: wrap
